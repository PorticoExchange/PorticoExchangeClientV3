...
enum opcodetype
{
    ...
    OP_NLOCKTIME = 0xb3,
    OP_NOP4 = OP_NLOCKTIME
    OP_RELATIVETIME = 0xb4,
    OP_NOP5 = OP_RELATIVETIME,
    OP_NOP4 = 0xb3,
    OP_NOP5 = 0xb4,
    OP_NOP6 = 0xb5,
    OP_NOP7 = 0xb6,
    ...
    OP_SWAP
OP_IF
    OP_SHA256 OP_FROMALTSTACK 1 OP_ADD OP_TOALTSTACK
OP_ENDIF
OP_HASH160

OP_SWAP
OP_IF
    OP_SHA256 OP_FROMALTSTACK 2 OP_ADD OP_TOALTSTACK
OP_ENDIF
OP_HASH160

OP_SWAP
OP_IF
    OP_SHA256 OP_FROMALTSTACK 4 OP_ADD OP_TOALTSTACK
OP_ENDIF
OP_HASH160

OP_SWAP
OP_IF
    OP_SHA256 OP_FROMALTSTACK 8 OP_ADD OP_TOALTSTACK
OP_ENDIF
OP_HASH160

OP_SWAP
OP_IF
    OP_SHA256 OP_FROMALTSTACK 16 OP_ADD OP_TOALTSTACK
OP_ENDIF
OP_HASH160
